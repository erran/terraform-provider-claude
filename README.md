...
| `claude_skill` | A custom [Agent Skill](https://platform.claude.com/docs/en/api/python/beta/skills/create) (`skill_...`) | Beta API; `files` seed the first version and are write-only. Changing `files` uploads a new version; `display_title` forces replacement. |
